...
def _get_data(arglist):
    ...
    q = build_query_string(dates_for_each, m, ch, v, os, application=app, architecture=ar)
...
if __name__ == '__main__':
    ...
    dates_versions = requests.get(
        ...
        'aggregates_by/build_id/channels/' + ch + '/dates/').text
    ...
    for v in new_versions.keys():
        ...
        options = requests.get(
            'https://aggregates.telemetry.mozilla.org/'
            'filters/?channel=' + ch + '&version=' + v).text
